      ...
      render: ({ rowData }) => {
        return [
          <a
            ...
            onClick={() => handleToPage('/grwl/mo-component', rowData)}
          >
            {intl.get(`${preCode}.component`).d('组件')}
          </a>,
          <a
            style={{ marginLeft: '10px' }}
            onClick={() => handleToPage('/grwl/mo-operation/list', rowData)}
          >
            {intl.get(`${preCode}.operation`).d('工序')}
          </a>,
          <a
            style={{ marginLeft: '10px' }}
            onClick={() => handleToPage('/grwl/production-task/list', rowData)}
          >
