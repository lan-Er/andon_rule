 ...
 * 广日物流二开-下达MO
 */
export async function grwlReleaseMo(params) {
  return request(`${myModule.lmess}/v1/${organizationId}/grwl-mos/release`, {
    method: 'POST',
    body: params,
  });
}
...
// 合并工单
export async function grwlMergeOrder(params) {
  return request(`${myModule.lmess}/v1/${organizationId}/grwl-mos/merge`, {
    method: 'POST',
    body: params,
  });
}
