...
function PqcQualityInspectionTask(props) {
      ...
      dispatch({
        ...
        .then((res) => {
          if (res) {
            ...
            setFirstAmount(res.firstAmount);
  ...
  function getContentLeft(organizationId) {
    ...
    return new Promise((response, rej) => {
      dispatch({
        type: 'qualityInspectionTask/queryBoardPqcPending',
        payload: {
          organizationId: organizationId || orgId,
        },
      })
  ...
  function getFooterLeft(organizationId) {
    ...
    return new Promise((response, rej) => {
      dispatch({
        type: 'qualityInspectionTask/queryBoardPqcChecked',
        payload: {
          organizationId: organizationId || orgId,
        },
      })
  ...
  return (
    <div className={style['shipment-task-kanban']}>
      <DashboardHeader title="PQC质检任务看板" history={props.history} />
      {totalLoading ? (
...
export default connect()(PqcQualityInspectionTask);
