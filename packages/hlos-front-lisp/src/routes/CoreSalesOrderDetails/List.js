...
import { coreListDS } from '@/stores/soDetailsDS';
...
const CoreSalesOrderDetails = (props) => {
  const todoListDataSetFactory = () =>
    new DataSet({
      ...coreListDS(),
    });
  const ListDS = useDataSet(todoListDataSetFactory, CoreSalesOrderDetails);
  ...
  function columns() {
    return [
      ...
      { name: 'attribute11', tooltip: 'overflow', width: 120 },
      {
        name: 'attribute29',
        width: 200,
        tooltip: 'overflow',
...
export default CoreSalesOrderDetails;
