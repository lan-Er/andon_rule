...
import { ListDS } from '@/stores/enterpriseAbnormalOrderDS';
...
const AbnormalOrder = (props) => {
  ...
  useEffect(() => {
    ...
    const typeArr = ['urgent', 'change', 'cancel', 'delay', 'unstandard'];
    ...
    return [
      ...
      },
      {
        ...
        columns: [
          ...
          { name: 'attribute1', editor: false, width: 150, lock: true },
          {
            name: 'attribute4',
            editor: false,
            width: 150,
      ...
      },
      {
        ...
        columns: [
          ...
          { name: 'attribute11', editor: false, width: 150 },
          { name: 'attribute12', editor: false, width: 150 },
          { name: 'delayDays', editor: false, width: 150 },
          { name: 'attribute1', editor: false, width: 150 },
          { name: 'price', editor: false, width: 150 },
        ],
      },
  ...
  function formRender() {
    return (
      <Form dataSet={listDS.queryDataSet} columns={1}>
        ...
        <Select name="attribute3" key="attribute3" />
