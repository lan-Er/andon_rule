 ...
 * @LastEditTime: 2020-06-30 13:17:50
 */
        ...
        <div className="order-view">
          ...
          <div className="item-list">
            <div className="order-item">
              <div className="item-header">订单总量</div>
            ...
            <div className="order-item">
              <div className="item-header">待确认</div>
            ...
            <div className="order-item">
              <div className="item-header">待下达</div>
            ...
            <div className="order-item">
              <div className="item-header">已下达</div>
            ...
            <div className="order-item">
              <div className="item-header">生产中</div>
            ...
            <div className="order-item">
              <div className="item-header">发运中</div>
