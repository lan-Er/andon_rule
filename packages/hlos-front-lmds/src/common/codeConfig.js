...
const code = {
  ...
  inspectionTemplate: {
    ...
    sampleJudgeMode: 'LMDS.SAMPLE_JUDGE_MODE', // 判定模式
  ...
  lmdsTaskProcessing: {
    taskType: 'LTCC_BRANCH_TASK_TYPE', // 任务类型
    taskStatus: 'LTCC_BRANCH_TASK_STATUS', // 任务状态
    userOrg: 'HIAM.USER.ORG',
  },
  lmdsEquipmentResume: {
    type: 'LMDS.EQUIPMENT_TRACK_TYPE',
  },
};
