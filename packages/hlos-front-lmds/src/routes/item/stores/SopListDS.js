...
export default () => ({
  ...
  fields: [
    ...
    {
      name: 'shipToleranceType',
      type: 'string',
      label: intl.get(`${preCode}.shipToleranceType`).d('发货允类型'),
      lookupCode: lmdsItem.shipToleranceType,
    },
    {
      name: 'shipTolerance',
      type: 'number',
      label: intl.get(`${preCode}.shipTolerance`).d('发货允差'),
