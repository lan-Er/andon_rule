 ...
 * @Date: 2020-12-28 11:37:15
 * @LastEditTime: 2021-02-23 09:47:53
...
export default () => ({
  ...
  queryFields: [
    ...
    },
    {
      name: 'partyObj',
      type: 'object',
      label: intl.get(`${preCode}.partyObj`).d('商业实体伙伴名称'),
  ...
  fields: [
    ...
    },
    {
      name: 'description',
      type: 'string',
      label: intl.get(`${preCode}.description`).d('工时单价描述'),
    },
    {
      name: 'assignRule',
      type: 'string',
