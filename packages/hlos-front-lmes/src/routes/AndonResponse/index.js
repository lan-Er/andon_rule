...
import { responseApi, createRepairTask } from '@/services/andonCloseService';
...
const AndonClose = (props) => {
  ...
  const handleSearch = async (dataCollectType, organizationId, currentStatus) => {
    ...
    ds.queryParameter = {
      ...
      dataCollectType,
      organizationId,
      currentStatus: currentStatus || 'TRIGGERED',
    };
  ...
  const handleExit = () => {
    ...
    closeTab('/pub/lmes/andon-response');
  };
  ...
  async function Trigger() {
    ...
    const res = await responseApi(params);
    if (getResponse(res)) {
      handleSearch(collectType, orgId);
      setActiveItem('');
      setDetailData({});
          ...
          <div className={styles['pane-left']}>
            <div className={styles['pane-item-wrapper']}>
              {currentAndonList.map((i) => (
                ...
                >
                  <img src={redAndonImg} alt="" onClick={(e) => handleTriggerConfirm(i, e)} />
                    ...
                    {i.showMask && (
                      <div className={styles['item-mask']}>
                        ...
                        <div>
                          ...
                          <Button color="primary" onClick={handleTrigger}>
                            {intl.get('hzero.common.button.sure').d('确定')}
                          </Button>
                        </div>
                      </div>
            ...
            <div className={styles['pane-right']}>
              ...
              <div className={styles['andon-progress']}>
                <div className={styles['progress-item']}>
                  <div className={`${styles.status} ${styles.current}`}>
