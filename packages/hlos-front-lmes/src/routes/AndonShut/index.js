...
import { closeApi } from '@/services/andonCloseService';
...
const AndonClose = (props) => {
  ...
  const handleSearch = async (dataCollectType, organizationId, currentStatus) => {
    ...
    ds.queryParameter = {
      ...
      dataCollectType,
      organizationId,
      currentStatus: currentStatus || 'RESPONSED',
    };
          ...
          <div className={styles['pane-left']}>
            <div className={styles['pane-item-wrapper']}>
              {currentAndonList.map((i) => (
                ...
                >
                  <img src={yellowAndonImg} alt="" onClick={(e) => handleTriggerConfirm(i, e)} />
