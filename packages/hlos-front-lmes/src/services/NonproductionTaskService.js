...
/**
 * 查询GET /v1/{tenantId}/tasks/np-submit-task-query
 */
export async function queryNonproductionTask(params) {
  return request(`${commonUrl}/np-submit-task-query`, {
    method: 'GET',
    query: params,
  });
}
...
/**
 * 运行POST /v1/{tenantId}/tasks/run-task
 */
...
/**
 * 完成 POST /v1/{tenantId}/tasks/submit-np-task-result
 */
export async function completeTask(params) {
  return request(`${commonUrl}/submit-np-task-result`, {
    method: 'POST',
    body: params,
  });
}
...
/**
 * 任务退料 /v1/{tenantId}/tasks/returnTaskInput
 */
