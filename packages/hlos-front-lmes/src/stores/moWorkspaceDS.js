  ...
  return {
    ...
    queryFields: [
      ...
      },
      {
        ...
        lovCode: lmesMoWorkspace.itemQuery,
        ignore: 'always',
      },
      {
        name: 'itemId',
      ...
      },
      {
        name: 'topMoOnly',
        type: 'boolean',
        label: intl.get(`${preCode}.topMoOnly`).d('仅顶层MO'),
        defaultValue: false,
      },
    ],
    transport: {
  ...
  return {
    ...
    fields: [
      ...
      },
      {
        name: 'ruleCodeObj',
        type: 'object',
        label: intl.get(`${preCode}.customerItemDesc`).d('编码规则'),
        lovCode: lmesMoWorkspace.ruleCode,
        noCache: true,
        ignore: 'always',
      },
      {
        name: 'numberRule',
        type: 'string',
        bind: 'ruleCodeObj.ruleCode',
      },
      {
        name: 'numberRuleName',
        type: 'string',
        bind: 'ruleCodeObj.ruleName',
      },
    ],
    transport: {
      read: () => {
