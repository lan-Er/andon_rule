...
export default class DetailList extends PureComponent {
  ...
  get columns() {
    return [
      ...
      { name: 'relatedGroup', editor: true, width: 120 },
      { name: 'inspectionClass', width: 130 },
      { name: 'standardValue2', width: 120 },
      { name: 'standardValue3', width: 120 },
      {
        name: 'inspectionItem',
      ...
      { name: 'defaultUclAccept', editor: false, width: 110 },
      { name: 'defaultLcl', editor: false, width: 100 },
      { name: 'defaultLclAccept', editor: false, width: 110 },
      { name: 'necessaryFlag', editor: true, width: 110 },
