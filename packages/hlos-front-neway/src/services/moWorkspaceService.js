...
import { HLOS_LMES, HLOS_LMDS, HLOS_LRPT, HLOS_LMESS } from 'hlos-front/lib/utils/config';
...
export async function releaseMo(params) {
  return request(`${HLOS_LMESS}/v1/${organizationId}/neway-mos/workbench/release`, {
    method: 'POST',
    body: params,
  });
}
