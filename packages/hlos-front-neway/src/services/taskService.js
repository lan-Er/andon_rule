...
import { HLOS_LMES, HLOS_LMDS, HLOS_LWMS, HLOS_LMESS } from 'hlos-front/lib/utils/config';
...
export async function holdTask(params) {
  return request(`${HLOS_LMESS}/v1/${organzationId}/neway-productive-tasks/hold-task`, {
    method: 'POST',
    body: params,
  });
}
...
export async function cancelTask(params) {
  return request(`${HLOS_LMESS}/v1/${organzationId}/neway-productive-tasks/cancel-task`, {
    method: 'POST',
    body: params,
  });
}
