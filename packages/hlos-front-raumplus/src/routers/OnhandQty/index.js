...
export default class OnhandQty extends Component {
  ...
  get columns() {
    return [
      ...
      {
        title: intl.get(`${preCode}.sourceNumber`).d('关联单据'),
        dataIndex: 'sourceNum',
        width: 128,
        resizable: true,
      },
      {
        title: intl.get(`${preCode}.projectNumber`).d('项目号'),
        dataIndex: 'projectNum',
        width: 128,
        resizable: true,
      },
      {
        title: intl.get(`${commonCode}.location`).d('地理位置'),
