  ...
  return {
    ...
    queryFields: [
      ...
      },
      {
        ...
        type: 'string',
        lookupCode: 'LWMS.EXECUTELING_STATUS_ERP',
        label: '是否已同步',
      },
      {
      ...
      },
      {
        name: 'executeLineId',
        type: 'string',
        label: intl.get(`${commonCode}.org`).d('执行明细ID'),
      },
    ],
    fields: [
      {
      ...
      },
      {
        name: 'warehouseName',
        type: 'string',
        label: intl.get(`${commonCode}.warehouseCode`).d('仓库名称'),
      },
      // {
      //   name: 'wmArea',
      //   type: 'string',
    ...
    transport: {
      read: () => {
        return {
          ...
          url: `${HLOS_LWMSS}/v1/${organizationId}/raumplus-execute-line`,
          method: 'GET',
        };
      },
    },
