...
export default {
  namespace: 'senyuDeliveryExecution',
  state: {
    /**
     * 发货数据集合
     * Array<{
  ...
  effects: {
    ...
    *fetchOrberStatus({ payload }, { call }) {
      return getResponse(yield call(updateOrberStatus, payload));
    },
    *fetchBasketList({ payload }, { call }) {
      return getResponse(yield call(getBasketList, payload));
    },
  },
  reducers: {
