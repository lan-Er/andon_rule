...
export default connect(({ senyuDeliveryExecution }) => ({
  selectedIds: senyuDeliveryExecution?.selectedIds,
  ...
  const handleClick = () => {
    history.push({
      pathname: `/pub/senyu/delivery-execution-detail/${rec.shipOrderId}`,
      state: {
        rec,
        recList,
      },
