...
import { Tooltip, ModalContainer } from 'choerodon-ui/pro';
...
import { unPackTag } from '@/services/tagPrintService';
    ...
    axios({
      ...
      .then(async (res) => {
        if (res) {
          ...
          // 解绑
          const result = await unPackTag(checkValuesParams);
