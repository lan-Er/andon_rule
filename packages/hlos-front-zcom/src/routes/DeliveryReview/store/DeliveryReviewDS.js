      ...
      read: ({ data }) => {
        ...
        return {
          url: generateUrlWithGetParam(
            `${HLOS_ZCOM}/v1/${organizationId}/delivery-orders/queryByCustomer`,
            {
    ...
    transport: {
      read: ({ data }) => {
        ...
        return {
          ...
          url: `${HLOS_ZCOM}/v1/${organizationId}/delivery-orders/detailForCustomer/${deliveryOrderId}`,
          method: 'GET',
        };
      },
    },
