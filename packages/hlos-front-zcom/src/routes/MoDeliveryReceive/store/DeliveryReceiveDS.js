    ...
    transport: {
      read: ({ data }) => {
        return {
          ...
          url: `${HLOS_ZCOM}/v1/${organizationId}/mo-delivery-order-lines/getMoDeliveryReceiveLine`,
          data: {
            ...data,
      ...
      read: ({ data }) => {
        ...
        return {
          url: generateUrlWithGetParam(
            ...
            `${HLOS_ZCOM}/v1/${organizationId}/mo-delivery-order-lines/getMoDeliveryReceiveLine`,
            {
              idList,
            }
          ),
