...
import { HLOS_LMDS } from 'hlos-front/lib/utils/config'; // 待调整
...
import { purchaseRequirementReleaseDS, componentDS } from './store/purchaseRequirementDS';
import { orderStatusRender, surnamesRender, getSerialNum } from '@/utils/renderer';
import ComponentModal from './ComponentModal';
import styles from './index.less';

const dashboardConfig = 'LISP.PURCHASE_TEMPLATE'; // 待调整
...
const PurchaseRequirementRelease = (props) => {
  ...
  function columns() {
    return [
      ...
      { name: 'poNum', lock: 'left', width: 150, tooltip: 'overflow' },
      {
        name: 'attribute3',
        tooltip: 'overflow',
        width: 120,
  ...
  return (
    <Fragment>
      <Header title="需求发布">
        ...
        <ExcelExport
          requestUrl={`${HLOS_LMDS}/v1/${organizationId}/psi-elements/excel`} // 待调整
