/**
 * @Description: 采购协同-需求发布DS
 * @Author: wei.zhou05@hand-china.com
 * @Date: 2020-10-21 14:25:57
 */

import moment from 'moment';
import { DEFAULT_DATE_FORMAT } from 'utils/constants';
import { HLOS_LISP } from 'hlos-front/lib/utils/config'; // 待调整
import { getCurrentUser, filterNullValueObject } from 'utils/utils';
import codeConfig from '@/common/codeConfig';

const { common } = codeConfig.code;
const url = `${HLOS_LISP}/v1/datas`; // 待调整
  ...
  return {
    ...
    queryFields: [
      ...
      },
      {
        ...
        transformRequest: (value) => value && value.poNum,
      },
      {
        name: 'attribute6',
        label: '供应商',
