...
export default function LineDetail(props) {
  ...
  function mainFields() {
    return [
      ...
      <LovPermission
        permissionList={[
          {
            code: `hlos.zexe.mo.workspace.ps.lov.routing`,
            type: 'lov',
            meaning: '工艺路线',
          },
        ]}
      ...
      />,
      <Lov name="secondUomObj" noCache disabled={!isCreate || allDisabled} key="secondUomObj" />,
      <TextField
  ...
  function demandFields() {
    return [
      <Lov name="demandObj" noCache disabled={allDisabled} key="demandObj" />,
      <TextField name="soNum" disabled={allDisabled} key="soNum" />,
      <TextField name="soLineNum" disabled={allDisabled} key="soLineNum" />,
      <Lov name="customerObj" noCache disabled={allDisabled} key="customerObj" />,
      <Lov name="customerSiteObj" noCache disabled={allDisabled} key="customerSiteObj" />,
    ...
    return [
      ...
      <div name="executeRuleObj" key="executeRuleObj-wrap">
        <LovPermission
          permissionList={[
            {
              code: `hlos.zexe.mo.workspace.ps.lov.executerule`,
              type: 'lov',
              meaning: '执行规则',
            },
          ]}
