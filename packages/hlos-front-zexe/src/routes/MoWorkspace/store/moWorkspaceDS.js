...
const { common, zexeMoWorkspace } = codeConfig.code;
  ...
  return {
    ...
    queryFields: [
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.moStatus,
        multiple: true,
    ...
    transport: {
      read: ({ data }) => {
        ...
        return {
          url: generateUrlWithGetParam(`${HLOS_ZEXE}/v1/${organizationId}/report/mo-list`, {
            moStatusList,
          }),
          data: {
            ...data,
  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.planRule,
      },
      {
        name: 'planLevel',
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.capacityType,
      },
      {
        name: 'capacityValue',
        type: 'number',
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.referenceType,
      },
      {
        name: 'referenceMoObj',
        type: 'object',
    ...
    transport: {
      read: () => {
        return {
          url: `${HLOS_ZEXE}/v1/${organizationId}/report/mo-plans`,
          method: 'GET',
        };
      },
    },
  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.executeStatus,
      },
      {
        name: 'workcellObj',
        type: 'object',
      ...
      },
      {
        ...
        lookupCode: zexeMoWorkspace.completeControlType,
      },
      {
    ...
    transport: {
      read: () => {
        return {
          url: `${HLOS_ZEXE}/v1/${organizationId}/report/mo-executes`,
          method: 'GET',
        };
      },
    },
...
const MoDetailDS = () => {
  return {
    ...
    transport: {
      read: () => {
        return {
          url: `${HLOS_ZEXE}/v1/${organizationId}/report/mo-list`,
          method: 'GET',
        };
      },
      create: ({ data }) => {
