...
import { ListDS } from '../store/PurchaserProductOrderInputOutputReportDS';
import { executeLines } from '@/services/purchaserPOReportService';
import ItemDimension from './ItemSummaryModal';
import './style.less';

const commonCode = 'zexe.common.model';
const preCode = 'zexe.purchaserProductOrderInputOutputReport';
const organizationId = getCurrentOrganizationId();
const url = `${HLOS_ZEXE}/v1/${organizationId}/report/mo-inputration-purchaser`;

const PurchaserProductOrderInputOutputReport = () => {
  ...
  function calcTableHeight(dataLength) {
    const pageContainer = document.getElementsByClassName('zexe-purchaser-p-o-input-output')[0];
    const queryContainer = document.getElementById('purchaserReportHeaderQuery');
  ...
  return (
    <Fragment>
      ...
      <Content className="zexe-purchaser-p-o-input-output">
        <div id="purchaserReportHeaderQuery" className="header-query">
...
export default formatterCollections({
  code: ['zexe.purchaserProductOrderInputOutputReport', 'zexe.common'],
})(PurchaserProductOrderInputOutputReport);
