...
const supplierContactsUrl = `${HLOS_ZMDA}/v1/${organizationId}/supplier-contactss`;
const supplierSiteUnitsUrl = `${HLOS_ZMDA}/v1/${organizationId}/supplier-site-units`;
const supplierSitesUrl = `${HLOS_ZMDA}/v1/${organizationId}/supplier-sites`;
...
const listDS = () => ({
  ...
  fields: [
    ...
    },
    {
      name: 'supplierName',
      type: 'string',
      label: intl.get(`${intlPrefix}.supplierName`).d('供应商全名称'),
    },
    {
      name: 'supplierShortName',
      type: 'string',
    ...
    },
    {
      ...
      type: 'number',
      label: intl.get(`${intlPrefix}.supplierShortName`).d('供应协同'),
    },
  ],
  transport: {
    read: ({ data }) => {
...
const addressDS = () => ({
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      label: intl.get(`${intlPrefix}.supplierSiteType`).d('地点用途'),
      lookupCode: 'ZMDA.SUPPLIER_SITE_TYPE',
      required: true,
    },
    {
      name: 'enabledFlag',
