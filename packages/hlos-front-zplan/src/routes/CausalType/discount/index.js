...
import { discountListDS } from '../store/indexDS';
import styles from './index.less';

const organizationId = getCurrentOrganizationId();

const intlPrefix = 'zplan.timePredictionModel';
const ListDS = new DataSet(discountListDS());
  ...
  const columns = [
    {
      name: 'discountCode',
      align: 'center',
      editor: (record) => !record.get('discountId'),
      required: true,
    },
    { name: 'discountName', align: 'center', editor: true },
    {
      name: 'minRate',
      align: 'center',
      editor: true,
