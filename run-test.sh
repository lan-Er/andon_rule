...
export BUILD_API_HOST=http://hlostest.api.onestep-cloud.com
export BUILD_CLIENT_ID=hlos-front-test
export BUILD_WFP_EDITOR=""
export BUILD_WEBSOCKET_HOST=http://hlostest.api.onestep-cloud.com/hpfm/sock-js
export BUILD_PLATFORM_VERSION=SAAS
export BUILD_BPM_HOST=http://hlostest.api.onestep-cloud.com
export BUILD_IM_ENABLE=false
export BUILD_IM_WEBSOCKET_HOST=ws://im.hlostest.onestep-cloud.com
...
find ./html -name '*.js' | xargs sed -i "s https://zoneda.onestep-cloud.com http://hlostest.api.onestep-cloud.com g"